...
```bash
vibe plugin install @vibecontrols/vibe-plugin-ai-minimax
```

Or install the npm package directly into an existing project that hosts the VibeControls agent:

```bash
bun add @vibecontrols/vibe-plugin-ai-minimax
# or
npm install @vibecontrols/vibe-plugin-ai-minimax
```
...
- npm: <https://www.npmjs.com/package/@vibecontrols/vibe-plugin-ai-minimax>
- Source: <https://github.com/algoshred/vibe-plugin-ai-minimax>
- Plugin contract / SDK: <https://github.com/algoshred/vibecontrols-plugin-sdk>
- Plugin catalogue: <https://vibecontrols.com/plugins/ai-minimax>
